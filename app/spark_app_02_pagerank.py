...
if __name__ == "__main__":
    ...
    t1DF.select("tweet.FriendsCount","tweet.FollowersCount").write.csv("/output/t1DF", mode="append")
    t1DF.select("tweet.Author","tweet.FollowersCount").write.csv("/output/t1DF-author", mode="append")
